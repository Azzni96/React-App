  ...
  return (
    <article className="w-full rounded-md bg-stone-600">
      ...
      <div className="p-4">
        ...
        <p>
          <Link
            className="block bg-stone-500 p-2 text-center w-63 transition-all duration-500 ease-in-out hover:bg-stone-700"
            to="/single"
            state={{item}}
          >
            Show
          ...
          <button onClick={() => {
            console.log('Modify');
          }} className="block bg-sky-500 p-2 text-center w-63 transition-all duration-500 ease-in-out hover:bg-sky-700">Modify</button>
           <button onClick={() => {
            console.log('Delete');
          }} className="block bg-red-500 p-2 text-center w-63 transition-all duration-500 ease-in-out hover:bg-red-700">
            Delete
          </button>
          </>
          )}
